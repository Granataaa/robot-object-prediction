# Robot Object Prediction Assignment : Homework 1

## Deliverable 1: MLP Position Prediction
- **Test Error (MSE):** 0.04897
- **Loss Curve:** ![Loss MLP](loss_mlp.png)

## Deliverable 2: CNN Position Prediction
- **Test Error (MSE):** 0.00034
- **Loss Curve:** ![Loss CNN](loss_cnn.png)

## Deliverable 3: Post-Action Image Reconstruction
- **Test Error (MSE):** 0.00060
- **Loss Curve:** ![Loss Recon](loss_recon.png)
- **Reconstructed Images (Top: Real, Bottom: Generated):**
![Reconstruction](reconstruction_results.png)

### Analysis of Results
The image reconstruction model (U-Net with Skip Connections) successfully learned to reconstruct static environment features (walls, robot arm) with high fidelity.
